...
public class ImplicitSurface: Shape {
    ...
    override func localNormal(_ localPoint: Tuple4) -> Tuple4 {
        let gradFx = (f(localPoint.x + EPSILON, localPoint.y, localPoint.z) - f(localPoint.x, localPoint.y, localPoint.z))
        let gradFy = (f(localPoint.x, localPoint.y + EPSILON, localPoint.z) - f(localPoint.x, localPoint.y, localPoint.z))
        let gradFz = (f(localPoint.x, localPoint.y, localPoint.z + EPSILON) - f(localPoint.x, localPoint.y, localPoint.z))
