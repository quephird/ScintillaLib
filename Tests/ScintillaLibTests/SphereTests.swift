...
class SphereTests: XCTestCase {
    func testIntersectTangent() throws {
        ...
        let s = Sphere()
        let intersections = s.localIntersect(r)
    ...
    func testIntersectScaledSphere() throws {
        ...
        let s = Sphere()
            .scale(2, 2, 2)
        let intersections = s._intersect(worldRay)
        XCTAssertEqual(intersections.count, 2)
    ...
    func testNormalPointOnXAxis() throws {
        ...
        let actualValue = s.normal(world, p)
    ...
    func testNormalTranslatedSphere() throws {
        ...
        let actualValue = s.normal(world, Point(0, 1.70711, -0.70711))
    ...
    func testNormalTransformedSphere() throws {
        ...
        let actualValue = s.normal(world, Point(0, sqrt(2)/2, -sqrt(2)/2))
