...
struct TDOR: ScintillaApp {
    var world = World {
        ...
        Camera(600, 600, PI/3, .view(
            ...
            Point(0, 0, 0),
            Vector(0, 1, 0)))
        ImplicitSurface((-0.5, 0.0, -0.5), (0.5, 1.0, 0.5), { x, y, z in
        ...
        Cylinder(-2.0, 1.0, true) // Candle body
            .scale(0.4, 1.0, 0.4)
            .material(.solidColor(0.1, 0.3, 0.7, .hsl))
        Cylinder(-0.5, 1.0, true) // Melted wax streak 1
            .scale(0.1, 1.0, 0.1)
        ...
        Sphere() // Drip at end of wax streak 1
            ...
            .material(.solidColor(0.1, 0.3, 0.7, .hsl))
        Cylinder(0.5, 1.0, true) // Melted wax streak 2
            .scale(0.1, 1.0, 0.1)
        ...
        Sphere() // Drip at end of wax streak 2
            ...
            .material(.solidColor(0.1, 0.3, 0.7, .hsl))
        Cylinder(-2.0, 1.0, true) // Melted wax streak 3
            .scale(0.1, 1.0, 0.1)
